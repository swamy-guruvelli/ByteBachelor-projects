...
A timeline lab comparing fan-out-on-write, fan-out-on-read, and a hybrid.
...
Generate a celebrity account; compare publish cost, read latency, and storage amplification.

## Learning target

Fan-out, celebrity users, cursor pagination, ranking, cache design, partitioning.
