...
Streaming object transfer with durable metadata, integrity checks, and resumable uploads.
...
Interrupt and resume a multipart upload; compare proxy streaming with presigned transfer.

## Learning target

Blob storage, object keys, streaming, checksums, presigned URLs, multipart lifecycle.
