...
A batched observability pipeline with hot queries and columnar archive.
...
Compare row and columnar scans; create a cardinality explosion; submit late data.

## Learning target

Batching, compression, cardinality, retention, downsampling, Parquet, backpressure.
