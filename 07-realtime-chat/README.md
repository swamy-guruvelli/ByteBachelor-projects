...
WebSocket messaging with per-conversation order, presence, and offline history.
...
Connect users through two gateways; disconnect and replay; delay out-of-order messages.

## Learning target

Persistent connections, ordering, heartbeats, pub/sub, horizontal gateways.
